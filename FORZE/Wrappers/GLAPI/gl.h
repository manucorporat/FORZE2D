#ifndef __fakegl_es20_h_
#define __fakegl_es20_h_
...
GL_API void         GL_APIENTRY glBufferSubData (GLenum target, GLintptr offset, GLsizeiptr size, const GLvoid* data) {}
    GL_API GLenum       GL_APIENTRY glCheckFramebufferStatus (GLenum target) {return 0;}
...
GL_API GLuint       GL_APIENTRY glCreateProgram (void) {return 0;}
GL_API GLuint       GL_APIENTRY glCreateShader (GLenum type) {return 0;}
...
GL_API int          GL_APIENTRY glGetAttribLocation (GLuint program, const GLchar* name) {return 0;}
...
GL_API int          GL_APIENTRY glGetUniformLocation (GLuint program, const GLchar* name) {return 0;}
...
GL_API GLboolean    GL_APIENTRY glIsFramebuffer (GLuint framebuffer) {return 0;}
GL_API GLboolean    GL_APIENTRY glIsProgram (GLuint program) {return 0;}
GL_API GLboolean    GL_APIENTRY glIsRenderbuffer (GLuint renderbuffer) {return 0;}
GL_API GLboolean    GL_APIENTRY glIsShader (GLuint shader) {return 0;}
