#ifndef __fakegl_es20ext_h_
#define __fakegl_es20ext_h_
...
#if GL_APPLE_sync
    GL_API GLsync glFenceSyncAPPLE(GLenum condition, GLbitfield flags) {return 0;}
GL_API GLboolean glIsSyncAPPLE(GLsync sync) {return 0;}
GL_API void glDeleteSyncAPPLE(GLsync sync) {}
GL_API GLenum glClientWaitSyncAPPLE(GLsync sync, GLbitfield flags, GLuint64 timeout) {return 0;}
...
#if GL_EXT_map_buffer_range
GL_API GLvoid *glMapBufferRangeEXT(GLenum target, GLintptr offset, GLsizeiptr length, GLbitfield access) {return 0;}
...
GL_API GLboolean glIsQueryEXT(GLuint id) {return 0;}
...
GL_API GLuint glCreateShaderProgramvEXT(GLenum type, GLsizei count, const GLchar **strings) {return 0;}
...
GL_API GLboolean glIsProgramPipelineEXT(GLuint pipeline) {return 0;}
...
GL_API GLvoid * GL_APIENTRY glMapBufferOES (GLenum target, GLenum access) {return 0;}
GL_API GLboolean GL_APIENTRY glUnmapBufferOES (GLenum target) {return 0;}
#endif
...
GL_API GLboolean glIsVertexArrayOES(GLuint array) {return 0;}
#endif
